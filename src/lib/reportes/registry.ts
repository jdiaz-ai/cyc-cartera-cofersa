...
export const REPORTES: ReporteDef[] = [
  ...
  // ═══ VENTAS ═════════════════════════════════════════════════════════════
  {
    ...
    descripcion: 'Antigüedad de saldos por vendedor y supervisor, con desglose de los 6 tramos.',
    categoria:   'VENTAS',
    icono:       'Users',
    roles:       ['COORDINADOR'],
  ...
  {
    id:          'estado-cuenta-masivo',
    titulo:      'Estado de Cuenta Masivo',
    descripcion: 'Generar y enviar estados de cuenta a varios clientes a la vez.',
    categoria:   'COBRANZA',
    icono:       'Send',
    roles:       ['COORDINADOR'],
    href:        '/reportes/estado-cuenta-masivo',
    formatos:    ['pdf', 'excel'],
    programable: false,
    disponible:  false,
  },
  ...
  // ═══ CONTROL / GAS ══════════════════════════════════════════════════════
  {
    ...
    descripcion: 'Listado de clientes con bloqueo de crédito y su saldo en cartera.',
    categoria:   'CONTROL',
    icono:       'Ban',
    roles:       ['COORDINADOR'],
    href:        '/reportes/clientes-bloqueados',
    formatos:    ['pantalla', 'pdf', 'excel'],
    programable: true,
    disponible:  false,
  },
  {
    ...
    descripcion: 'Facturas con condición de pago especial y su estado de vencimiento.',
    categoria:   'CONTROL',
    icono:       'CalendarClock',
    roles:       ['COORDINADOR'],
